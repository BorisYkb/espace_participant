							...
							<div className="col-lg-12">
								<div className="header-elements">
									<div className="site-logo">
										<Link href="/index5"><img src="/assets/img/logo/logo6.png" alt="" /></Link>
									</div>
									<div className="main-menu">
										<ul>
											<li><Link href="/index5">Accueil </Link></li>
											<li><Link href="/a_propos_de_levenement5">A Propos de l'évènement</Link></li>
									...
									<li>
										<Link href="/inscription5" className="vl-btn4-header4">
