					...
					<div className="row">
						...
						<div className="col-lg-4 col-md-6 mb-4">
							<div className="past-event-card" data-aos="fade-up" data-aos-duration={600}>
								<div className="event-image-container">
									<img 
										src="/public/assets/img/event_img/R.jpeg" 
						...
						<div className="col-lg-4 col-md-6 mb-4">
							<div className="past-event-card" data-aos="fade-up" data-aos-duration={800}>
								<div className="event-image-container">
									<img 
										src="/assets/img/past-events/forum-agro-abidjan-2022.jpg" 
						...
						<div className="col-lg-4 col-md-6 mb-4">
							<div className="past-event-card" data-aos="fade-up" data-aos-duration={600}>
								<div className="event-image-container">
									<img 
										src="/assets/img/past-events/expo-elevage-2022.jpg" 
						...
						<div className="col-lg-4 col-md-6 mb-4">
							<div className="past-event-card" data-aos="fade-up" data-aos-duration={1000}>
								<div className="event-image-container">
									<img 
										src="/assets/img/past-events/conference-foret-2024.jpg" 
