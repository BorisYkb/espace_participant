...
export default function Section5() {
	...
	return (
		<>
			...
			<div className="testimonials1-section-area sp1 mt-5">
					...
					<div className="row align-items-center">
						<div className="col-lg-6">
							...
							<div className='heading2'>
								...
								<p >Découvrez en vidéo les moments forts et les opportunités uniques qui vous attendent lors de notre conférence "Innover et Réussir en 2025". Plongez dans l'ambiance inspirante de cet événement incontournable.</p>
								<br />
								<p>La conférence “Innover et Réussir en 2025” est bien plus qu’un simple rassemblement : c’est un véritable rendez-vous d’inspiration et d’opportunités. Durant cette journée exceptionnelle, des experts, des entrepreneurs et des leaders visionnaires partageront leurs expériences et dévoileront les stratégies qui façonnent le monde de demain. Que vous soyez étudiant, entrepreneur, professionnel ou passionné de nouveauté, cet événement vous donnera les outils et la motivation nécessaires pour franchir une nouvelle étape dans vos projets.</p>
