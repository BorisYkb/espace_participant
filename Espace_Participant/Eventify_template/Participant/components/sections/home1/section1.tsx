...
export default function Section1() {
    ...
    const handleConfirm = (participationType: 'online' | 'physical') => {
        // Ici vous pouvez traiter la confirmation
        console.log('Type de participation choisi:', participationType);
        ...
        alert(`Votre participation "${participationType === 'online' ? 'En ligne' : 'En présentiel'}" a été enregistrée !`);
    };
                        ...
                        <div className="col-lg-6">
                            <div className="hero1-header heading1">
                                <h5 data-aos="fade-left" data-aos-duration={800}>
                                    ...
                                    Bienvenue, CHONOU SEKA ORIANE NANCY
                                </h5>
                                ...
                                <div className="btn-area1" data-aos="fade-left" data-aos-duration={1100}>
                                    <button onClick={handleOpenModal} className="vl-btn1 border-0">
